...
Patch220: BZ-647134-mirrorlist-timeout.patch
Patch221: BZ-697087-repolist.patch
Patch222: BZ-709972-repos-timestamp_check-no-revert.patch
Patch223: BZ-712896-sslcacert-m2crypto-exploding.patch

# 5.8 patches...

Patch230: BZ-662175-update-to.patch
Patch231: BZ-552279-reset-nice-config.patch
Patch232: BZ-749337-localupdate-installs-multilib.patch

# RE patches...
Patch233: RE-allow-users-to-clean.patch
...
%changelog
* Fri Dec 14 2012 Mitsuru Y <mitsuruy@reallyenglish.com> 3.2.22-41
- Allow users to clean.

* Mon May 21 2012 Zdenek Pavlas <zpavlas@redhat.com> 3.2.22-40
- Don't update-install same version diff. arch local pkgs.
- Resolves: rhbz#749337

* Tue Nov 29 2011 James Antill <jantill@redhat.com> - 3.2.22-39
- Add reset_nice config. option, and turn it on by default.
- Resolves: rhbz#552279

* Fri Oct 28 2011 James Antill <jantill@redhat.com> - 3.2.22-38
- Add update-to and upgrade-to commands.
- Resolves: rhbz#662175

* Tue Jun 14 2011 James Antill <jantill@redhat.com> - 3.2.22-37
- Fix for sslcacert as unicode making m2crypto explode.
- Resolves: rhbz#712896

* Fri Jun  3 2011 James Antill <jantill@redhat.com> - 3.2.22-36
- Repos with timestamp_check as false will now not revert.
- Resolves: rhbz#709972

* Wed Jun  1 2011 James Antill <jantill@redhat.com> - 3.2.22-35
- Fix bad backport due to newer usage of size.
- Resolves: rhbz#647134

* Tue May 10 2011 James Antill <jantill@redhat.com> - 3.2.22-34
